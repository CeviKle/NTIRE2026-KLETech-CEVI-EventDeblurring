...
class ImageEventErestormerModel(BaseModel):

    def __init__(self, opt):
        super(ImageEventErestormerModel, self).__init__(opt)
    ...
    def feed_data(self, data):
        ...
        event = data.get('voxel', data.get('event', None))
    ...
    def optimize_parameters(self, current_iter):
        ...
        preds = self.net_g(self.lq, self.event)
    ...
    def test(self):
        ...
        with torch.no_grad():
            ...
            if tile is None or tile == 0:
                self.output = self.net_g(self.lq, self.event)
                ...
                for h_idx in h_idx_list:
                    for w_idx in w_idx_list:
                        ...
                        out_patch = self.net_g(in_patch, e_patch)
